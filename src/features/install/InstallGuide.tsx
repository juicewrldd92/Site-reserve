...
import { REQUIRED_BROWSER, STEPS, type Platform } from './platform'

/**
 * Les trois gestes d'installation, avec la maquette du téléphone.
 *
 * Partagé entre la page d'après-inscription et la vitrine : le jour où Apple
 * déplace un bouton, il n'y a qu'un endroit à corriger.
 */
export function InstallGuide({
  ...
  platform: Platform
  onBack: () => void
  /** Absent sur la vitrine : personne n'a de compte à rejoindre. */
  onDone?: () => void
}) {
